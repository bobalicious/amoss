...
echo -----------------------------------------------------------------------
./combine-release-notes $newversionname "sfdx force:package:install --package \"$newversionalias\"" "https://login.salesforce.com/packaging/installPackage.apexp?p0=$newversionid"

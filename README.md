...
`sfdx force:package:install --package "amoss@0.9.0-0"`
...
For Dev Instances or Production, the Unlocked Package can be installed via:
    https://login.salesforce.com/packaging/installPackage.apexp?p0=04t4K000002O0PZQA0

For all other instances:
    https://test.salesforce.com/packaging/installPackage.apexp?p0=04t4K000002O0PZQA0
